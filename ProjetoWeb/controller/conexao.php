...
class Conexao
{ //Clase de Conexão do arquivo, responsável por ligar a tabela do Banco de Dados ao arquivo PHP. 
    ...
    {  //Método Construtor da ligação SQL.
    ...
    { //Método Get, retorna os valores passados no Método Construtor.
        return $this->conexao;
    }
}