...
class Pessoa
{ // Definindo a Classe Pessoa, responsável por definir os atributos que a "pessoa" precisa ter, e manda-los para a sua tabela no Banco de Dados.//
    ...
    { //Método Get, puxando puxa as informações dos Atributos acima.//
        return $this->id;
    }
    public function setId($id)
    { //Método Set, "define como", as informações dos Atributos acima.//
        $this->id = $id;
    }
    ...
    { //Método Inserir, transferindo os valores da tela de cadastro das informações para a Tabela Cliente no Banco de Dados.//
